...
<div class="p-3">
	<form action="{{ url('/akun') }}" method="post">
		...
		<div class="form-floating mb-2">
			<input type="text" class="form-control @error('no_ktp') is-invalid @enderror" name="no_ktp" value="{{ old('no_ktp') }}" placeholder="No KTP" onkeypress="return isNumber(event)" maxlength="16"> 
			<label for="floatingInput">No KTP</label>
			@error('no_ktp')
		...
		<div class="form-floating mb-2">
			<input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Name Registrasi"> 
		...
		<div class="form-floating mb-2">
			<input type="text" class="form-control @error('no_telepon') is-invalid @enderror" name="no_telepon" value="{{ old('no_telepon') }}" placeholder="No Telepon" onkeypress="return isNumber(event)" maxlength="13"> 
		...
		<div class="form-floating mb-2">
			<select name="status_akses" class="form-control @error('status_akses') is-invalid @enderror">
				<option value="{{ old('status_akses') }}">{{ old('status_akses') }}</option>
		...
		<div class="form-floating mb-2">
			<input type="number" class="form-control @error('usia') is-invalid @enderror" name="usia" value="{{ old('usia') }}" placeholder="Usia" onkeypress="return isNumber(event)" maxlength="3"> 
		...
		<div class="form-floating mb-2">
			<input type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status') }}" placeholder="Status"> 
		...
		<input type="submit" value="Registrasi" class="btn btn-primary" style="float:right;">
		<br><br><br>
