...
<div class="p-3">
	<form action="{{ url('/pasien/save') }}" method="post">
		...
		<div class="form-floating mb-2">
			<input type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status') }}" placeholder="Status Pekerjaan"> 
